...
<Lecture {lecture}>
  <p>
    Once your <a href="/assignments/site-research">Site Research</a> is complete, you'll have the context you need to get
    to a productive conversation with the client quickly. This article will prepare you for the structure the conversation
    is going to follow.
  </p>
  ...
  <p>
    There are a couple rough edges to using most online tools, and this one is no exception. We will be using the
    backlog table layout during this meeting:
  </p>
  ...
  <p>
    The meeting will open by letting the client describe what they're looking for from a website. As they talk through
    these initial ideas, we'll create entries in the project that we can come back to later in the conversation. If we
    were using notecards, each of these would be written on individual cards.
  </p>

  <p>
    Following the initial capture of ideas, we'll circle back to each of the cards to break them down into smaller
    pieces. Here is a general outline of how that should go:
  </p>

  <ol>
    <li>Bring up a story in the conversation, ask them to provide more detail.</li>
    <li>
      For each item they describe, create an additional story in the backlog. With notecards, you would be creating a
  ...
  <p>
    Since we only have an hour, we don't have the luxury to dive deep on every item. After each story is split, take a
    moment to think about which one will be the most complicated to create.
  </p>
  ...
  <ul>
    <li>
      <a href="https://niksilver.com/2015/05/19/user-story-sizing/">
        Nik Silver, one of my favorite Agile bloggers, providing guidance on how small to make stories.
      </a>
    </li>
    <li>
      <a href="https://martinfowler.com/bliki/UserStory.html">
        Martin Fowler, well known author of the Agile Manifesto, providing a brief description of user stories.
      </a>
    </li>
    <li>
      <a href="https://ronjeffries.com/xprog/articles/expcardconversationconfirmation">
        Another author of the Agile Manifesto, Ron Jeffries, discussing what goes into a story in more depth.
      </a>
    </li>
  </ul>
